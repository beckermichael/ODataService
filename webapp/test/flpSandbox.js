		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bestellfreigabe",
									"targetURL": "#odatagervicegruppe1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odatagervicegruppe1-display": {
								"semanticObject": "odatagervicegruppe1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odatagervicegruppe1",
									"url": sap.ui.require.toUrl("odatagervicegruppe1")
								}
							}
						}
					}
